...
<p align="center">
  <img width="250px" src="https://github.com/NosCoreIO/NosCore.Shared/blob/master/icon.png"/>
</p>

[![NuGet](https://img.shields.io/nuget/v/NosCore.Shared.svg?style=flat-square)](https://www.nuget.org/packages/NosCore.Shared/)
[![.NET](https://github.com/NosCoreIO/NosCore.Shared/actions/workflows/dotnet.yml/badge.svg?branch=master)](https://github.com/NosCoreIO/NosCore.Shared/actions/workflows/dotnet.yml)
